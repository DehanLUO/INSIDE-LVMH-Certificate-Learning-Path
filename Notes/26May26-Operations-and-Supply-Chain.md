...
- Operations cover all steps to transform a creative design into a product delivered to the final customer.
	- [x] True
	- [ ] False
...
- According to Mohamed Marfouk, the four stages of Operations at LVMH are:
	 [ ] Research
	 [ ] Learning
	 [ ] Advertising
	 [x] Manufacturing
...
- To develop highly successful Operations at LVMH, the Group is taking care of 3 P's. Before Mohamed Marfouk gives you the answer, what is your guess?
	- [x] People - Planet - Profit
	- [ ] People - Pruducts - Promotion
	- [ ] Passion - Principles - Placement
	- [ ] Planning - Process - Partnership
...
*Discover how manufacturing drives excellence and innovation at LVMH, through its unique features, shared values, and key challenges across the Group’s Maisons.*

**Purpose & core missions**

At LVMH, manufacturing goes far beyond the transformation of raw materials into finished products. Every aspect of manufacturing reflects the Group’s values, heritage, and expertise. The Operations teams focus on three core missions: **attracting and developing new talents** through dedicated academies, **supporting each Maison** in its transformation projects, and **facilitating the sharing of best practices** and innovation across the Group.

**Common values & shared specificities: our strength**

LVMH’s Maisons operate in diverse sectors, each with **distinct industrial processes**, ranging from cosmetics and leather goods to wines and watches. Despite this diversity, all Maisons share a common culture and follow **three fundamental principles** in production:

- **Savoir-Faire**: Preserving heritage and transmitting exceptional craftsmanship and creative skills is central to every process.

- **Quality**: A commitment to continuous improvement ensures the highest standards in product quality, industrial processes, and working conditions.

- **Agility**: Manufacturing sites foster agility, enabling rapid and effective responses to both expected and unexpected changes to secure a sustainable competitive advantage.

**Challenges: translating innovation into production**

In today’s fast-changing world, there are **major challenges** to be tackled both within our Group and across Maisons, as well as externally. Sustaining the growth of the Maisons requires **meeting increased demand** while maintaining savoir-faire, which calls for ongoing recruitment and training of new talents.

Teams must also adapt to **fluctuating market demands**, whether surges due to influencer trends or downturns from global events such as the pandemic.

Furthermore, **continuous innovation** and a **diverse product portfolio** present the challenge of managing industrial complexity and reducing time to market.

Finally, **efficient resource management**, especially for rare and precious materials, is essential for improving the environmental footprint and providing transparent information to consumers.

**Manufacturing at LVMH: an opportunity to work in a variety of worlds**

With over 75 Maisons across six sectors, LVMH offers a **unique environment** to experience a variety of industrial processes. The exceptional quality of each product is rooted in the expertise of manufacturing teams, whose knowledge is the result of years of dedication and experience. Being at the heart of the industrial process allows you to work alongside **highly experienced and passionate people**.

**Technology & Savoir-Faire**

We are in the era of **manufacturing 4.0**, where digital technologies are integrated to enhance efficiency, quality, and working conditions in our factories. However, **technology must remain at the service of savoir-faire**, and only implemented when it brings clear value. The Group believes in the power of collective Human Intelligence before Artificial Intelligence.
...
*Discover how sourcing at LVMH creates value and addresses the complex challenges of a global luxury leader.*

**Sourcing at LVMH: Value creation across the Source-to-Pay process**

At LVMH, sourcing, also known as purchasing or procurement, is a strategic function that extends far beyond acquiring products or services. It delivers value throughout the entire Source-to-Pay (S to P) process, focusing on five key dimensions: **quality, cost, lead time, innovation, and risk**. The priorities and impact of sourcing vary according to market conditions, whether in periods of growth, downturns, or geopolitical uncertainty.

**Three pillars of sourcing coordination**

Sourcing activities are structured around three main pillars:
- **Category expertise**: Sourcing teams are composed of professional purchasers who understand the specific needs of each category, such as IT & Digital, Marketing & Communication, Finance, Retail Capex and Opex, Business Travel, Human Resources, Facility Management, Energy, Logistics, and Transportation.
- **Advisory**: Sourcing provides support to Maisons at various stages of maturity, from establishing purchasing teams and implementing procurement tools to developing tailored category strategies.
- **Transversal topics**: As a Group-level function, sourcing coordinates cross-Maison networks, focusing on community animation, sustainability in the Supply Chain, and training through the Purchasing Academy.

**Scope of actions**

The value of sourcing depends on the **level of specificity** of the purchase and the **organization of the supplier market**:
- For global needs like IT suites, centralized contracts at the **LVMH level** benefit all Maisons.
- For needs such as energy, contracts are managed at the **country level** to address local market structures since the supplier market is organized at country level.
- For highly specific needs, like grapes for champagne, sourcing is managed directly by the **relevant division or Maison**.

**Direct and indirect purchasing**

On one hand, **direct purchasing** concerns products included in the Cost of Goods Sold (COGS): ingredients, raw materials, textiles, primary packaging, and subcontracted parts or finished products. These are typically managed at the **Maison or Business Division level**. Group sourcing only intervenes when shared suppliers are identified across Maisons, enabling information sharing and collective negotiation.

On the other hand, **indirect purchasing** covers categories outside COGS, such as Marketing & Communication, Logistics, IT, and Digital, which are managed at several levels:
- **Global**: Category managers based at LVMH headquarters in Paris manage contracts with worldwide suppliers for the entire Group.
- **Regional**: Dedicated teams in Paris, New York, Shanghai, Hong Kong, and Tokyo oversee regional suppliers and ensure the effectiveness in their respective markets.
- **Country**: Purchasers in key countries such as Italy and Switzerland handle local supplier relationships and adapt contracts to national specificities, notably for energy and utilities.

**Major challenges and new sourcing trends**

Sourcing at LVMH must constantly adapt to a VUCA (Volatility, Uncertainty, Complexity & Ambiguity) environment. Supply chains face **frequent disruptions** (Covid, taxes, boycotts, and so on), new regulations require **increased compliance** (Corporate Sustainability Reporting Directive, Corporate Sustainability Due Diligence Directive), and raw material stocks must be **managed with agility**. **Flexibility** is essential, and sourcing teams play a critical role in supporting LVMH’s performance and resilience in this ever-changing context.
...
*Uncover how the LVMH Supply Chain ensures product availability, adapts to new challenges, and supports the Group’s commitment to quality, innovation, and sustainability across all Maisons.*

**Understanding the Supply Chain at LVMH**

Supply Chain refers to the **management of the flow of products and services** to deliver the right products and services, at the right time, with the best quality, optimal quantity, and at the right cost. This involves strategic design of the production and distribution network, demand forecasting, production and distribution planning, inventory sizing, and transportation.

At LVMH, Supply Chain is **central to the client promise**: ensuring product availability in stores and online, seamless delivery, and efficient returns are key factors in client satisfaction and loyalty. Today, Supply Chain is also about leading transformation to adapt to a volatile, uncertain, complex, and ambiguous (VUCA) world.

**Key specificities of the LVMH Supply Chain**

There is not one single Supply Chain at LVMH, but nearly as many as there are Maisons, reflecting the Group’s decentralized structure. Despite this diversity, all Supply Chains share distinct characteristics:

- **Global distribution**: products reach clients worldwide.
- **Product diversity**: from limited-edition luxury pieces to products sold in large quantities.
- **Wide diversity of clients**: serving a large range of expectations, cultures, and delivery requirements.
- **Multiple sales channels**: including retail, wholesale, e-commerce, and marketplaces.
- **Operational constraints**: managing raw material scarcity and limited manufacturing capacity.
- **Focus on product quality and client experience**: ensuring excellence at every step.

The complexity and variety of these Supply Chains make them among the most stimulating and challenging in the industry.

**Within LVMH, the Supply Chain transformation is based on 5 key pillars:**
- **Sustainability and Corporate Social Responsibility**: LVMH is committed to making products that are not only beautiful, but also sustainable. The Group works to reduce greenhouse gas emissions and continuously improve Supply Chain practices, from raw material sourcing to transportation.
- **Agility**: In an unpredictable world, agility and resilience are key. The Supply Chain must adapt rapidly to unexpected events, whether a global crisis, logistical disruption, or sudden demand shifts. Recent years have shown the ability to react quickly and efficiently.
- **E-commerce**: Luxury initially struggled with e-commerce, but digital is now central. Consumer behaviour shifts have led Maisons to integrate technology throughout the Supply Chain. E-commerce is expected to represent over 30% of sector sales by 2030. The aim is to offer a seamless experience between digital and physical worlds, always maintaining standards of excellence.
- **Artificial Intelligence**: The Supply Chain teams are increasingly leveraging AI to improve performance. Machine learning supports sales forecasting, stock distribution, and operational alerts. Teams remain attentive to new AI developments and future applications to identify and test the next use cases.
- **People**: Behind every successful Supply Chain are great people and teams around the world. At LVMH, people make the difference. Attracting and developing new Supply Chain talents is essential to meet the Group's many exciting challenges.

**Supporting excellence: the role of the Group Operations department**

To address these challenges, LVMH has established a centre of expertise at the Holding level, uniting Supply Chain, Manufacturing, and Purchasing. This Group Operations department supports the Maisons in their operational and strategic Supply Chain challenges (growth, agility, efficiency, quality, and sustainability), while respecting each Maison’s autonomy.
...
This oscillation between long-cycle activities (the ageing of our *eaux de vie* over several years) and short-cycle activities (filling bottles, packing them in thousands of boxes in a few days, then shipping them to more than 160 countries) is defining and singular to our Maison.
...
- What are the main levers to minimize the impact of a product on the environment? *Choose the wrong answer*
